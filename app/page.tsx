    ...
    <div className="mx-auto">
      ...
      <section className="mx-auto mt-20 max-w-7xl px-4">
        <div className="relative overflow-hidden rounded-3xl bg-black">
          ...
          <Image
            src={
              lifestyle?.backgroundImage?.url
                ? `${lifestyle.backgroundImage.url}`
                : "https://images.unsplash.com/photo-1590461283969-47fedf408cfd?fm=jpg&q=60&w=3000&auto=format&fit=crop"
            }
            alt={lifestyle?.backgroundImage?.title || "Hero image"}
            width={1920}
            height={1080}
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-10 text-white">
            <h3 className="text-3xl font-black md:text-5xl">
              {lifestyle?.title || "Built for the mountain"}
            </h3>

            <p className="mt-4 max-w-xl text-sm text-white/70 md:text-base">
              {lifestyle?.blurb || "Performance snow gear designed for riders who push conditions, terrain, and limits."}
            </p>
